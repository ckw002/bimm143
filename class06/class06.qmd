...
Today we are going to expore R functions and begin to think about writing our own functions. 
...
I wnt to find the location of the min value not the value itself. For this I can use `which.min()`
